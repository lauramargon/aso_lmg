...
Una vez creado la GPO configuraremos la directiva **Cuentas; cambiar el nombre de la cuenta de administrador**

![](imagenes/0504.1.png)

Habilitaremos la directiva **Inicio de sesion interactivo: no requerir Crtl+Alt+Supr** 
...
El titulo se configura la directiva **Inicio de sesión interactivo: Título del mensaje para usuarios que intentan iniciar sesión**
Para colocar el texto usamos la directiva **Inicio de sesión interactivo: Texto del mensaje para usuarios que intentan iniciar sesión**
...
Para que no muestre el ultimo nombre de usuario usaremos la directiva **Inicio de sesión interactivo: No mostrar el último nombre de usuario**

![](imagenes/0504.4.png)

Para poder apagar el sistema sin tener que iniciar sesion hay que habilitar la directiva **Apagado: Permitir que el sistema se apague sin tener que iniciar sesión**
...
Creamos la GPO y la vinculamos a la raiz
...
Creamos un directorio al cual le he dado permisos y he compartido con GRP_Profesores_General

![](imagenes/0504.7.png)

Ahora asignaremos la unidad al directorio y configuraremos para que solo le salga a GRP_Profesores_General

![](imagenes/0504.8.png)

![](imagenes/0504.9.png)

He iniciado sesión con prof_info_1 y podemos observar el directorio con la letra P asignada

![](imagenes/0504.10.png)
...
Ya hemos creado el acceso directo

![](imagenes/0504.11.png)

Ahora voy a poner como requisito que solo les aparezca a los usuarios del GRP_Alumnos_DAM

![](imagenes/0504.12.png)

Iniciamos sesion con alu_dam_1 y observamos el acceso directo

![](imagenes/0504.13.png)
...
Habilitamos la directiva  **Apagado: borrar el archivo de paginación de la memoria virtual**

![](imagenes/0504.14.png)

Le colocamos el filtro VMI

![](imagenes/0504.15.png)

Ahora lo vinculamos a la **GPO_Highperf_Security**

![](imagenes/0504.16.png)
...
Deshabilitamos la directiva **Control de cuentas de usuario: detectar instalaciones e aplicaciones y pedir confirmación de elevación**

![](imagenes/0504.17.png)

Configuramos el filtro VMI para que solo puedan entrar sistemas operativos de escritorio.

![](imagenes/0504.18.png)

Añadimos el filtro a la **GPO_Clientes_UAC**

![](imagenes/0504.19.png)