...
Primero instalaremos el rol de **Servicios de dominio de Active Directory**

![](imagenes/0501.png)

Entraremos en el enlace **Promover este servidor a controlador de dominio**

![](imagenes/0502.png)

Seleccionamos **Agregar un nuevo bosque** y añadiremos como dominio **iessanandres.local**
...
Creamos una una Unidad organizativa
...
Creamos las unidades organizativas necesarias dentro de la que hemos creado anteriormente

![](imagenes/0507.png)

Esta es la apariencia del arbol 
...
Asignaremos los usuarios a sus grupos correspondientes
...
Una vez seleccionados colocamos la fraga horario indicada anteriormente para los alumnos

![](imagenes/0514.png)

En el caso de los profesores se ve asi

![](imagenes/0515.png)

En el caso del personal se ve asi
