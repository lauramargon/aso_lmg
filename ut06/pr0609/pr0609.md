...
Write-Host "`n=== INFORME DE RENDIMIENTO ===" -ForegroundColor Cyan
Write-Host "Muestras analizadas: $totalMuestras"
Write-Host ""
Write-Host "RESULTADOS DEL ANALISIS:"
Write-Host "- Carga Promedio: $promedio %"
Write-Host "- Pico Maximo: $picoMaximo %"
Write-Host "- Incidentes Criticos (>90%): $incidentesCriticos"
Write-Host ""

Write-Host "DIAGNOSTICO:"
if ($promedio -gt 70 -or $incidentesCriticos -gt 3) {
    Write-Host "[RECOMENDACION] NECESARIO UPGRADE DE HARDWARE" -ForegroundColor Red
} else {
    Write-Host "[RECOMENDACION] FALSA ALARMA. EL SERVIDOR AGUANTA" -ForegroundColor Green
}
Write-Host ""
