...
Introduce el primer número: 89
Introduce el segundo número: 65
Resultado: 24
laura@laura:~$ sh script.sh
Menú de operaciones:
1) Suma
...
Introduce el primer número: 1324
Introduce el segundo número: 124
Resultado: 164176
laura@laura:~$ sh script.sh
Menú de operaciones:
1) Suma
...
Introduce el primer número: 2134
...
laura@laura:~$ sh script.sh
Introduce el nombre del archivo: laura.txt
...
Introduce el valor a convertir: 3121
Resultado: 951.2808 m
```
...
laura@laura:~$ sh script.sh
Introduce un número: 445
El número es positivo.
laura@laura:~$ sh script.sh
Introduce un número: -354
...
laura@laura:~$ sh script.sh
Introduce el nombre del servicio (por ejemplo, apache2): nginx
1) Iniciar servicio
2) Detener servicio
